	...
	<div id="wrapper" class="clearfix">
		...
		<section id="content">
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="col_one_third nobottommargin">
						<div class="feature-box media-box">
							...
							<div class="fbox-desc">
								<h3>Website Development.<span class="subtitle">We provide great after-dev support.</span></h3>
								<p>We build websites for you reliably and inexpensively. We dont just replicate design templates, we look at your business and carve out a solution to meet your needs.</p>
							</div>
						</div>
					</div>
					...
					<div class="col_one_third nobottommargin">
						<div class="feature-box media-box">
							...
							<div class="fbox-desc">
								<h3>IT Services.<span class="subtitle">You probably have one or two IT staff and your technology needs are increasing.</span></h3>
								<p>Tap into our vast pool of experienced personnel by purchasing one of our support packages and let us provide remote and on-site support for your business at a reasonable cost.</p>
							</div>
						</div>
					</div>
					...
					<div class="col_one_third nobottommargin col_last">
						<div class="feature-box media-box">
							...
							<div class="fbox-desc">
								<h3>IT Support.<span class="subtitle">You probably have one or two IT staff and your technology needs are increasing.</span></h3>
								<p>Tap into our vast pool of experienced personnel by purchasing one of our support packages and let us provide remote and on-site support for your business at a reasonable cost.</p>
							</div>
						</div>
					</div>
				...
				<div class="section parallax dark" style="background-image: url('demos/construction/images/slider/1.jpg'); padding: 120px 0;" data-stellar-background-ratio="0.4">
				...
				<div id="portfolio" class="portfolio grid-container portfolio-full clearfix">
					...
					<article class="portfolio-item pf-media pf-icons">
						<div class="portfolio-image">
							...
							<div class="portfolio-overlay">
                                <a href="demos/construction/images/projects/full/1.jpg" class="left-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
						<!--	<a href="#" class="center-icon"><i class="icon-line-ellipsis"></i></a> -->
							</div>
						</div>
						<div class="portfolio-desc">
							<h3><a href="#">Exclusively Children</a></h3>
					...
					<article class="portfolio-item pf-illustrations">
						<div class="portfolio-image">
							...
							<div class="portfolio-overlay">
								<a href="demos/construction/images/projects/2.jpg" class="left-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
							</div>
						</div>
						<div class="portfolio-desc">
							<h3>Bakendales Cakes</h3>
					...
					<article class="portfolio-item pf-graphics pf-uielements">
						<div class="portfolio-image">
							...
							<div class="portfolio-overlay">
								<a href="demos/construction/images/projects/3.jpg" class="left-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
							</div>
						</div>
						<div class="portfolio-desc">
							<h3>idash Jobs</h3>
					...
					<article class="portfolio-item pf-icons pf-illustrations">
						<div class="portfolio-image">
							...
							<div class="portfolio-overlay">
								<a href="demos/construction/images/projects/full/4.jpg" class="left-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
							</div>
						</div>
						<div class="portfolio-desc">
							<h3>Kodelaborate</h3>
							<span>IT | E-Learning</span>
						</div>
					</article>
					...
					<article class="portfolio-item pf-uielements pf-media">
						<div class="portfolio-image">
							...
							<div class="portfolio-overlay">
								<a href="demos/construction/images/projects/5.jpg" class="left-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
							</div>
						</div>
						<div class="portfolio-desc">
							<h3>Mozuka</h3>
					...
					<article class="portfolio-item pf-graphics pf-illustrations">
						<div class="portfolio-image">
							...
							<div class="portfolio-overlay" data-lightbox="gallery">
								<a href="demos/construction/images/projects/6.jpg" class="left-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
							</div>
						</div>
						<div class="portfolio-desc">
							<h3>EDC</h3>
					...
					<article class="portfolio-item pf-uielements pf-icons">
						<div class="portfolio-image">
							...
							<div class="portfolio-overlay">
								<a href="demos/construction/images/projects/full/7.jpg" class="left-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
							</div>
						</div>
						<div class="portfolio-desc">
							<h3>EL Consulting</h3>
							<span>Cooperate | Business</span>
						</div>
					</article>
					...
					<article class="portfolio-item pf-graphics">
						<div class="portfolio-image">
							...
							<div class="portfolio-overlay">
								<a href="demos/construction/images/projects/full/8.jpg" class="left-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
							</div>
						</div>
						<div class="portfolio-desc">
							<h3>Women Discourse</h3>
							<span>Forum | Blog</span>
						</div>
					</article>
				...
				<div class="container topmargin-lg cleafix">
						...
						<div class="tabs tabs-justify nobottommargin clearfix" id="construction-tabs">
							...
							<div class="tab-container">
								...
								<div class="tab-content clearfix" id="construction-tab-3">
									<p>We have a young, proven team of dynamic minds, each brilliant, in their respective fields. UI Designers, Web & Mobile Developers, Content Architects, Framework Engineers, your business has access to the best in class!</p>
												...
												<div class="clear-bottommargin-sm">
													<div class="row clearfix">
														<div class="col-sm-6 bottommargin-sm">
															<address>
																<strong>Hostville Nigeria:</strong><br>
																21 Salvation Rd, Opebi<br>
																Ikeja Lagos, NG 100281<br>
															</address>
														</div>
														<div class="col-sm-6 bottommargin-sm">
															<abbr title="Phone Number"><strong>Phone:</strong></abbr> +234-809-349-5277<br>
															
															<abbr title="Email Address"><strong>Email:</strong></abbr> contact@hostvillenigeria.org
														</div>
													</div>
												</div>
											</div>
											<div class="col-sm-5 bottommargin-sm">
												<img src="http://maps.googleapis.com/maps/api/staticmap?center=21,+Salvation+rd,+Opebi,+Lagos&zoom=16&scale=false&size=300x180&maptype=roadmap&format=png&visual_refresh=true&markers=size:tiny%7Ccolor:0x008000%7Clabel:1%7C21,+Salvation+rd,+Opebi,+Lagos" alt="Google Map" class="img-thumbnail">
											</div>
										</div>
									</div>
					...
					<div class="col_one_fourth col_last">
						...
						<div class="widget quick-contact-widget clearfix">
							<h4>Request A Call | <span class="subtitle">We'll call you.</span></h4>
							<div class="quick-contact-form-result"></div>
							<form id="quick-contact-form" name="quick-contact-form" action="include/quickcontact.php" method="post" class="quick-contact-form nobottommargin">
								<div class="form-process"></div>
								<input type="text" class="required sm-form-control input-block-level" id="quick-contact-form-name" name="quick-contact-form-name" value="" placeholder="Full Name" />
								<input type="text" class="required sm-form-control email input-block-level" id="quick-contact-form-email" name="quick-contact-form-email" value="" placeholder="Email Address" />
								<textarea class="required sm-form-control input-block-level short-textarea" id="quick-contact-form-message" name="quick-contact-form-message" rows="4" cols="30" placeholder="Phone Number | Message"></textarea>
								<input type="text" class="hidden" id="quick-contact-form-botcheck" name="quick-contact-form-botcheck" value="" />
								<button type="submit" id="quick-contact-form-submit" name="quick-contact-form-submit" class="button button-small button-3d nomargin" value="submit">Request A Call</button>
							</form>
				...
				<div class="section nobg notopmargin nopadding footer-stick">
					<div class="container clearfix">
						...
						<div class="row">
							<div class="col-md-7">
								<img src="demos/construction/images/services/phone.png" alt="Bottom Trust">
							</div>
